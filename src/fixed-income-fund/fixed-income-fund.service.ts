...
@Injectable()
export class FixedIncomeFundService {
  private transporter;
  ...
  validateFixedIncomeFundData(formData: any) {
    const errors: string[] = [];
  ...
  async sendFixedIncomeFundRedemption(
    formData: any,
    pdfContent: string,
    adminEmail: string,
    currentDate: number
  ) {
    const referenceId = `PACAM-FIXED-INCOME-${currentDate}`;
    const htmlTemplate = this.createEmailTemplate(formData, referenceId);

    const mail_configs = {
      from: this.configService.get("EMAIL"),
      to: adminEmail,
      subject: "PACAM Fixed Income Fund Redemption Request",
      html: htmlTemplate,
      attachments: [
        {
          filename: `PACAM_FixedIncome_Redemption_${formData.fullName}_${currentDate}.pdf`,
          content: pdfContent,
          encoding: "base64",
        },
      ],
  ...
  async sendClientConfirmationEmail(
    ...
    const mail_configs = {
      ...
      subject: "PACAM Fixed Income Fund Redemption - Confirmation",
      html: htmlTemplate,
      attachments: [
        {
          filename: `PACAM_FixedIncome_Redemption_${formData.fullName}_${currentDate}.pdf`,
  ...
  private createEmailTemplate(formData: any, referenceId: string): string {
    const brandColor = "#7c3aed"; // Purple for fixed income
...
<head>
    ...
    <title>PACAM Fixed Income Fund Redemption Request</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2 class="title">Fixed Income Fund Redemption</h2>
            <p class="subtitle">New Stable Income Fund Redemption Request</p>
        </div>

        <div class="content">
            <div class="greeting">
                Dear Fixed Income Fund Management Team,
            </div>

            <p>A new Fixed Income fund redemption request has been submitted through the ${brandName} online portal. Please find the details below and process according to stable income fund procedures.</p>
            ...
            <div class="attachment-notice">
                ...
                The complete Fixed Income fund redemption form with signatures is attached to this email as a PDF document.
            </div>

            <!-- Important Notes -->
            <div class="important-notes">
                <h3>⚠️ Important Processing Notes - PACAM Fixed Income Fund</h3>
                <ul>
                    <li><strong>Stable Income Focus:</strong> Fixed Income fund designed for consistent income generation and capital preservation</li>
                    ...
                    <li><strong>Bond Portfolio:</strong> Fund invests primarily in bonds and fixed income securities for steady returns</li>
                    ...
                    <li>Fixed Income Fund characteristics: Lower volatility with consistent income generation</li>
                    <li>Ensure all calculations are verified before processing payment</li>
                    <li>Maintain audit trail for all fixed income transactions</li>
                </ul>
            </div>

            <!-- Submission Information -->
            <div class="submission-info">
                <strong>📈 Fixed Income Processing Required</strong><br>
                <strong>Submitted on:</strong> ${submissionDate}<br>
                <strong>Reference ID:</strong> ${referenceId}<br>
                <strong>Fund Type:</strong> PACAM Fixed Income Fund (Stable Income)<br>
                <strong>Processing Priority:</strong> Standard (2-4 business days)
            </div>

            <p>Please process this Fixed Income fund redemption request according to stable income fund procedures and notify the client upon completion. Consider the conservative nature of this bond-focused investment.</p>
        </div>

        <div class="footer">
            <div class="footer-content">
                <div class="contact-info">
                    <strong>${brandName} Fixed Income Fund Management</strong><br>
            ...
            <div class="copyright">
                ...
                This email was generated automatically from the ${brandName} Fixed Income fund portal.<br>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Fixed Income Fund Redemption Confirmation</title>
    <style>
        ...
        .confirmation-badge { background-color: #faf5ff; border: 2px solid #a855f7; border-radius: 10px; padding: 20px; text-align: center; margin: 20px 0; }
        .details-section { background-color: #f8fafc; border-left: 4px solid ${brandColor}; padding: 20px; margin: 20px 0; }
        .info-grid { display: grid; grid-template-columns: 1fr 2fr; gap: 10px; margin-bottom: 10px; }
        .info-label { font-weight: 600; color: #374151; }
        .info-value { color: #1f2937; }
        .next-steps { background-color: #f0f9ff; border-left: 4px solid ${brandColor}; padding: 20px; margin: 20px 0; }
        .important-notice { background-color: #fef3c7; border: 1px solid #f59e0b; border-radius: 8px; padding: 15px; margin: 20px 0; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>PACAM</h1>
            <h2>Fixed Income Fund Redemption Confirmation</h2>
        </div>
        ...
        <div class="content">
            ...
            <div class="confirmation-badge">
                <h3 style="color: #7c3aed; margin: 0;">✅ Stable Income Fund Redemption Request Received</h3>
                <p style="margin: 10px 0 0 0; color: #6b21a8;">Reference: <strong>${referenceId}</strong></p>
            </div>

            <p>Thank you for submitting your PACAM Fixed Income Fund redemption request. We have received your application and it is now being processed by our fixed income fund management team.</p>
            ...
            <div class="next-steps">
                ...
                <ul>
                    <li>Your redemption request will be processed within 2-4 business days</li>
            ...
            <div class="important-notice">
                ...
                <ul style="color: #92400e; margin: 0;">
                    ...
                    <li><strong>Stable Income:</strong> Fixed Income fund focuses on consistent income generation through bonds</li>
                    <li><strong>Processing Time:</strong> Standard processing is 2-4 business days</li>
                    <li><strong>Conservative Investment:</strong> This fund offers lower volatility with steady returns</li>
                </ul>
            </div>

            <p><strong>Reference Number:</strong> Please keep your reference number (${referenceId}) for all future correspondence.</p>

            <p>Thank you for choosing PACAM for your stable income investment needs.</p>
        </div>
